...
{
    public class ClearMissionIsCompleted : IsCompleted
    {
        ...
        public ClearMissionIsCompleted(NetworkBehaviour networkBehaviour, IEventBus eventBus, ScreensController screensController, CompletedMissionsModel completedMissionsModel, Mission mission) 
